 ...
 * @author pdsanchez
 */
public class WallPongApp extends Application {
    ...
    final private Circle ball = new Circle(BALL_RADIUS);
    final private Rectangle bat = new Rectangle(BAT_W, BAT_H);
